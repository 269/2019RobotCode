...
/**
 * Command to move elevator to preset positions for Hatch Panels
 */
public class elevatorPIDHatchPos extends Command {
  ...
  protected void interrupted() {
    end();//TODO: will the code actualy be ever interpted if the joystics are moved???
  }
}
